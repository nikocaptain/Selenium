...
public class C03_WindowHandle extends TestBase {
    ...
    public void test01() {
        ...
        driver.switchTo().newWindow(WindowType.WINDOW);//-->WindowType.WINDOW yeni pencere de  açar
        driver.get("https://www.youtube.com");         //-->WindowType.TAB yeni yeni sekme açar
    ...
    public void test02() {
        ...
        driver.switchTo().newWindow(WindowType.TAB);//-->WindowType.WINDOW yeni pencere de  açar
        driver.get("https://www.youtube.com");         //-->WindowType.TAB yeni yeni sekme açar
        String youtubeWindowHandle = driver.getWindowHandle();
